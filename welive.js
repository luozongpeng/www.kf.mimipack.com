	...
	function welive_mobile(){
		...
		welive_obj.drag.onclick = function(){
			...
			if(!welive_loaded) {
				...
				$_$("welive_iframe").src = welive_url + "mobile/welive.php?a=621256861&group=" + welive_groupid + "&gid=" + welive_gid + "&id=" + welive_id + "&fn=" + welive_fn + "&r=" + Math.random() + "&d=" + welive_same + "&url=" + url;
			}
	...
	function welive_web(){
		...
		welive_online.onclick = function(){
			...
			if(!welive_loaded) {
				...
				location.hash = "";
				var url = window.btoa(window.location.href);
				$_$("welive_iframe").src = welive_url + "welive.php?a=621256861&group=" + welive_groupid + "&gid=" + welive_gid + "&id=" + welive_id + "&fn=" + welive_fn + "&r=" + Math.random() + "&d=" + welive_same + "&url=" + url;
